...
Page{
    ...
    ListModel{
        ...
        ListElement{
            lable:"2013-09-01"
            text:'&nbsp;<img src="qrc:/qt/qml/start/res/image/image_1.jpg" align="top" width="144" height="102.4">&nbsp;考上中国皮城大学，杰斯武器工坊专业'
        }
        ListElement{
            lable:"2017-07-01"
    ...
    RowLayout{
        ...
        PrefsButton{
            ...
            onClicked: {
                btn_mode.text = text
                time_line.mode = Style.alternate
            }
        }
    }
