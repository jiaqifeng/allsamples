...
import Style 1.0
Item{
    property int mode: Style.left
    property alias model: repeater.model
    property bool isDark: false
    property color lineColor: isDark ? Qt.rgba(80/255,80/255,80/255,1) : Qt.rgba(210/255,210/255,210/255,1)
    id:control
    implicitWidth: 380
    ...
    QtObject{
        id:d
        property bool isLeft: control.mode === Style.left
        property bool isRight: control.mode === Style.right
        property bool isAlternate: control.mode === Style.alternate
    ...
    Component{
        ...
        Rectangle{
            ...
            radius: 8
            border.width: 4
            color:isDark ? Qt.rgba(0,0,0,1) : Qt.rgba(1,1,1,1)
